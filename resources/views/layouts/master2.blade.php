...
<head>
    ...
    <link type="image/css" href="{{ asset('images/icons/favicon.png') }}" rel="icon">
        ...
        <div class="container-menu-header">
            <div class="topbar">
                ...
                <span class="topbar-child1">
                    Free shipping for standard order over 500.00 MAD
                </span>
            ...
            <div class="wrap_header ">
                ...
                <div class="header-icons">
                    ...
                    <div class="header-wrapicon2">
                        <i class="fa fa-shopping-cart header-icon1 js-show-header-dropdown"
                            style="font-size:32px; color:black"></i>

                        <span class="header-icons-noti"
                            style=" width: 20px;height: 20px;font-size:15px; color:#fff;background-color:#dc3545">{{count(Cart::content())}}</span>
                            ...
                            <ul class="header-cart-wrapitem">
                                ...
                                <li class="header-cart-item">
                                    <div class="header-cart-item-img">
                                        ...
                                        <img src="{{asset('storage/'.$product->model->image)}}" alt="IMG">
                                    </div>
                                    ...
                                    <div class="header-cart-item-txt">
                                        ...
                                        <span class="header-cart-item-info">
                                            {{$product->qty}} x {{$product->model->getPrice()}}
                                        </span>
                                    </div>
                                </li>
                                @endforeach
                        ...
                        <div class="header-cart-total row justify-content-center">
                            <strong> Total : {{getPrice(Cart::total())}}</strong>
                        </div>
